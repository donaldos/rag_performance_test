...
사용법:
    ...
    python -m src.test.test_pdf_loading path/to/file.pdf --loader pymupdf --save out/docs.json

    # 로딩 결과 전체 내용 확인 (페이지별)
    python -m src.test.test_pdf_loading path/to/file.pdf --inspect
    python -m src.test.test_pdf_loading path/to/file.pdf --inspect --loader pdfplumber
    python -m src.test.test_pdf_loading path/to/file.pdf --inspect --page 2
...
from src.loading.pdf.loader_context import PDFLoaderContext  # noqa: E402
from src.loading.pdf.router import PDFTypeRouter            # noqa: E402
from src.test.io_utils import default_save_path, load_documents, save_documents  # noqa: E402
